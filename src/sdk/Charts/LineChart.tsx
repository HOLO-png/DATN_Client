...
//     const { roundUp, unitValue, ticksPadding, state, timeLineHolder, prevTimeLine, ignoreYFloat = false } = props
...
//               position: 'bottom',
//               align: 'start',
//               labels: { boxWidth: 12, boxHeight: 3, color: '#fff', padding: 5 }
//             },
//             tooltip: {
//               position: 'nearest',
...
//                     return `${ignoreYFloat ? context.raw : valueFormat} ${unitValue}`
//                   }
//                   return ''
//                 }
//               }
...
//           },
//           elements: {
//             point: { radius: isRangeFiveMin(startTimeRange, stopTimeRange) || state.isShowPoint ? 2 : 0 },
//             line: { borderWidth: 1 }
//           },
//           scales: {
//             x: {
//               grid: { color: '#4B4C57', borderWidth: 1 },
//               ticks: {
//                 color: '#fff',
//                 autoSkip: false,
//                 maxRotation: 0,
