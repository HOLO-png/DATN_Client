...
//     if (areaChart)
//       return date.minute() % formatKey.fifteenMin.area === 0 && date.second() === 0 ? date.format('HH:mm') : null
...
//     if (areaChart)
//       return date.minute() % formatKey.thirtyMin.area === 0 && date.second() === 0 ? date.format('HH:mm') : null
...
//     if (areaChart)
//       return date.minute() % formatKey.oneHour.area === 0 && date.second() === 0 ? date.format('HH:mm') : null
...
//     if (areaChart)
//       return date.hour() % formatKey.twelveHour.area === 0 && date.minute() === 0 && date.second() === 0
//         ? date.format('HH:mm')
//         : null
//     return date.hour() % formatKey.twelveHour.line === 0 && date.minute() === 0 && date.second() === 0
//       ? date.format('HH:mm')
//       : null
//   }
//   // 1 day
...
//     if (areaChart)
//       return date.hour() % formatKey.day.area === 0 && date.minute() === 0 && date.second() === 0
//         ? date.format('HH:mm')
//         : null
//     return date.hour() % formatKey.day.line === 0 && date.minute() === 0 && date.second() === 0
//       ? date.format('HH:mm')
//       : null
//   }
//   // 2 days
...
//       if (areaChart)
//         return date.hour() % formatKey.twoDays.area === 0 && date.minute() === 0 && date.second() === 0
//           ? date.format('MM/DD HH:mm')
//           : null
//       return date.hour() % formatKey.twoDays.line === 0 && date.minute() === 0 && date.second() === 0
//         ? date.format('MM/DD HH:mm')
//         : null
//     } else {
...
//       if (areaChart)
//         return date.hour() % formatKey.threeDays.area === 0 && date.minute() === 0 && !existInTimeline
//           ? date.format('MM/DD HH:mm')
//           : null
//       return date.hour() % formatKey.threeDays.line === 0 && date.minute() === 0 && !existInTimeline
//         ? date.format('MM/DD HH:mm')
//         : null
//     }
//     if (formatKey.status === 'mobile' && range > 3 * DAY_IN_SECOND && range <= 30 * DAY_IN_SECOND) {
//       return diffDay % 2 === 0 && date.hour() === 0 && date.minute() === 0 && !existInTimeline
//         ? date.format('MM/DD HH:ss')
//         : null
//     }
//     if (range > 3 * DAY_IN_SECOND && range <= 4 * DAY_IN_SECOND) {
//       if (formatKey.fourDays.area) {
//         if (areaChart)
//           return date.hour() % formatKey.fourDays.area === 0 && date.minute() === 0 && !existInTimeline
//             ? date.format('MM/DD HH:mm')
//             : null
//         return date.hour() % formatKey.fourDays.line === 0 && date.minute() === 0 && !existInTimeline
//           ? date.format('MM/DD HH:mm')
//           : null
//       } else {
...
//         if (areaChart)
//           return date.hour() % formatKey.fiveDays.area === 0 && date.minute() === 0 && !existInTimeline
//             ? date.format('MM/DD HH:mm')
//             : null
//         return date.hour() % formatKey.fiveDays.line === 0 && date.minute() === 0 && !existInTimeline
//           ? date.format('MM/DD HH:mm')
//           : null
//       } else {
//         return date.hour() === 0 && date.minute() === 0 && !existInTimeline ? date.format('MM/DD HH:mm') : null
...
//           return date.hour() % formatKey.week.area === 0 && date.minute() === 0 && !existInTimeline
//             ? date.format('MM/DD HH:mm')
//             : null
//         }
//         return date.hour() === 0 && date.minute() === 0 && !existInTimeline ? date.format('MM/DD HH:mm') : null
...
//           return date.hour() % formatKey.week.line === 0 && date.minute() === 0 && !existInTimeline
//             ? date.format('MM/DD HH:mm')
//             : null
//         }
//         return date.hour() === 0 && date.minute() === 0 && !existInTimeline ? date.format('MM/DD HH:mm') : null
...
//       return diffDay % 1 === 0 && date.hour() === 0 && date.minute() === 0 && !existInTimeline
//         ? date.format('MM/DD HH:mm')
//         : null
//     }
